...
//_____________________________________________________ADMIN ACTION ON CUSTOMERS_______________________________________________________________
    ...
    public ResponseEntity<ApiResponse<CustomerResponse>> getCustomerById(@RequestParam("id") Integer customerId){
    ...
    public ResponseEntity<ApiResponse<CustomerResponse>> activeCustomer(@PathVariable("id") Integer customerId){
    ...
    public ResponseEntity<ApiResponse<CustomerResponse>> inActiveCustomer(@PathVariable("id") Integer customerId){
...
//_____________________________________________________ADMIN ACTION ON DRIVERS________________________________________________________________
    ...
    public ResponseEntity<ApiResponse<DriverResponse>> getDriverById(@RequestParam("id") Integer driverId){
    ...
    public ResponseEntity<ApiResponse<DriverResponse>> activeDriver(@PathVariable("id") Integer driverId){
    ...
    public ResponseEntity<ApiResponse<DriverResponse>> inActiveDriver(@PathVariable("id") Integer driverId){
    ...
    public ResponseEntity<ApiResponse<CabResponse>> getCabById(@RequestParam("id") Integer cabId){
...
//_____________________________________________________ADMIN ACTION ON BOOKINGS_______________________________________________________________
    ...
    public ResponseEntity<ApiResponse<BookingResponse>> getBookingById(@RequestParam("id") Integer bookingId){
    ...
    public ResponseEntity<ApiResponse<PageResponse<BookingResponse>>> getBookingsByDriver(
            @RequestParam("id") Integer driverId,
            @RequestParam(defaultValue = "0") Integer page,
            @RequestParam(defaultValue = "10") Integer size
    ){
